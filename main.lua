--[[
 A simple shooter game with Corona, made to serve as a base tutorial for the physics engine.
 The game uses the Physics engine to handle movement and collisions.

 @author Alfred R. Baudisch
 @url http://karnakgames.com
 @license CODE and SOUNDS: Use and modify as you wish.
